...
MREG_SNAPSHOT_THROTTLE_RATE = envvar("MREG_SNAPSHOT_THROTTLE_RATE", "2/hour")
MREG_SNAPSHOT_MAX_BYTES = envvar("MREG_SNAPSHOT_MAX_BYTES", 10 * 1024 * 1024 * 1024)
MREG_SNAPSHOT_MAX_DURATION_SECONDS = envvar("MREG_SNAPSHOT_MAX_DURATION_SECONDS", 900)
