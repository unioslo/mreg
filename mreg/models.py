...
def prevent_hostgroup_parent_recursion(sender, instance, action, model, reverse, pk_set, **kwargs):
    """
    pk_set/child contains the group(s) being added to a group
    instance/parent is the group getting new group members

    This checks wether the parent is already a member of the child
