...
class PolicyRolloutTests(SimpleTestCase):
    ...
    @patch("mreg.policy.rollout._prometheus_value", side_effect=[100, 1, 2, 0, 0, 3])
    def test_fetch_rollout_snapshot_queries_every_gate(self, prometheus_value) -> None:
        ...
        self.assertEqual(snapshot, RolloutSnapshot(100, 1, 2, 0, 0, 3))
        self.assertEqual(prometheus_value.call_count, 6)
