...
class MetricsTests(TestCase):
    ...
    def test_request_count_increments_by_status(self) -> None:
        ...
        assert any("HealthHeartbeat" in k or "meta/health/heartbeat" in k for k in counts.keys()), f"No heartbeat endpoint in: {counts}"
    ...
    def test_request_without_resolver_match_uses_path(self) -> None:
        ...
        assert any("HealthHeartbeat" in k or "meta/health/heartbeat" in k for k in counts.keys()), (
    ...
    def test_inprogress_gauge_decrements_on_success(self) -> None:
        ...
        assert b"mreg_http_inprogress_requests" in metrics_resp.content, "In-progress gauge should be recorded"
    ...
    def test_ldap_metrics_failure_counter(self, mock_backend: Any) -> None:
        ...
        assert any('operation="bind"' in k and 'exception="LDAPError"' in k for k in failures.keys()), (
