...
urlpatterns = [
    ...
    path('labels/<name>', views_labels.LabelDetail.as_view()),
    ...
    re_path(r'^zones/forward/(?P<name>(\d+/)?[^/]+)/delegations/(?P<delegation>(.*))', views_zones.ForwardZoneDelegationDetail.as_view()),
