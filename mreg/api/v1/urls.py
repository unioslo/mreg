...
urlpatterns = [
    ...
    path('forwardzones/', views.ForwardZoneList.as_view()),
    path('forwardzones/<name>', views.ForwardZoneDetail.as_view()),
    path('forwardzones/<name>/nameservers', views.ForwardZoneNameServerDetail.as_view()),
    path('reversezones/', views.ReverseZoneList.as_view()),
    path('reversezones/<name>', views.ReverseZoneDetail.as_view()),
    path('reversezones/<name>/nameservers', views.ReverseZoneNameServerDetail.as_view()),
